...
class WindowConstructionShadeReviveProperties(object):
    """REVIVE cost and carbon properties for a honeybee-energy WindowConstructionShade.

    Aggregates per-layer material data (embodied carbon, cost, labor, lifetime)
    ...
    def host(self):
        ...
        """The honeybee-energy WindowConstructionShade this properties object is attached to."""
        return self._host

    @property
    def host_name(self):
        # type: () -> str
        """The display name of the host WindowConstructionShade, or 'No Host'."""
