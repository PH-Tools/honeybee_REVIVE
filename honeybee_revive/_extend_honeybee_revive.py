...
from .properties.space import SpaceReviveProperties
...
setattr(SpaceProperties, "_revive", None)
...
def space_revive_properties(self):
    if self._revive is None:
        self._revive = SpaceReviveProperties(self.host)
    return self._revive
...
setattr(SpaceProperties, "revive", property(space_revive_properties))
